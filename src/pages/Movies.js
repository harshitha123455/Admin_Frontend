      ...
      {showForm && (
        <Box>
          <Form onFinish={handleFormSubmit}>
            <Form.Item
              name="name"
              label={<span style={{ fontSize: "17px" }}>Name</span>}
              rules={[{ required: true }]}
            >
              <StyledInput
                style={{ width: "168px", marginLeft: "38px", height: "40px" }}
              />
            </Form.Item>

            <Form.Item
              name="image"
              label={<span style={{ fontSize: "17px" }}>Image</span>}
            ...
            <Form.Item
              name="duration"
              label={<span style={{ fontSize: "17px" }}>Duration</span>}
              rules={[{ required: true }]}
            >
              <TimePicker
                format="HH:mm:ss"
                style={{ width: "168px", marginLeft: "20px", height: "40px" }}
              />
            </Form.Item>
            <Form.Item
              name="genre"
              label={<span style={{ fontSize: "17px" }}>Genre</span>}
              rules={[{ required: true }]}
            >
              <StyledInput
                style={{ width: "168px", marginLeft: "38px", height: "40px" }}
            ...
            <Form.Item
              name="description"
              label={<span style={{ fontSize: "17px" }}>Description</span>}
              rules={[{ required: true }]}
            >
              <StyledTextArea
                style={{
            ...
            <Form.Item
              name="releaseDate"
              label={<span style={{ fontSize: "17px" }}>Release Date</span>}
              rules={[{ required: true }]}
            >
              <DatePicker
                style={{ width: "168px", marginLeft: "10px", height: "40px" }}
              />
            </Form.Item>
            <Form.Item
              name="cast"
              label={<span style={{ fontSize: "17px" }}>Cast</span>}
              rules={[{ required: true }]}
            >
              <StyledTextArea
                style={{
